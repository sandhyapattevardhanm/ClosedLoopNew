        ...
        <div className="border-t border-slate-700 mt-12 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-slate-300">hello@moderncorp.com</span>
            </div>
            <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mt-8 pt-8 border-t border-slate-700">
